            ...
            switch (a){
                case "Beds":
                    try (Connection con = DriverManager.getConnection(url, username, password);
                        ...
                        String selectQuery = "SELECT beds FROM The_Banglore_Hospital WHERE tid = 1";
                        ...
                        if (rs.next()) {
                            ...
                            System.out.println("Number of beds in The Banglore Hospital: " + beds);
                        } else {
                ...
                case "Ventilators":
                    try (Connection con = DriverManager.getConnection(url, username, password);
                        ...
                        String selectQuery = "SELECT ventilator FROM The_Banglore_Hospital WHERE tid = 1";
                        ...
                        // Process the result set
                        if (rs.next()) {
                            int ventilators = rs.getInt("ventilator");
                            System.out.println("Number of ventilators in The Banglore Hospital: " + ventilators);
                        } else {
                            System.out.println("No data found");
                        }
                ...
                case "Antidots":
                    try (Connection con = DriverManager.getConnection(url, username, password);
                        ...
                        String selectQuery = "SELECT antidotes FROM The_Banglore_Hospital WHERE tid = 1";
                        ...
                        // Process the result set
                        if (rs.next()) {
                            int antidotes = rs.getInt("antidotes");
                            System.out.println("Number of antidotes in The Banglore Hospital: " + antidotes);
                        } else {
                            System.out.println("No data found");
                        }
...
//                "CREATE TABLE Vivekananda_General_Hospital (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))",
//                "CREATE TABLE Hubli_Super_Speciality_Hospital (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))",
//                "CREATE TABLE Shivakrupa_Hospital_Durgani (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))",
//                "CREATE TABLE The_Banglore_Hospital (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))",
//                "CREATE TABLE Manipal_Hospital_Yeshvanthpur (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))",
//                "CREATE TABLE Victoria_Hospital (tid INT(20) PRIMARY KEY AUTO_INCREMENT, ttype VARCHAR(200), tvalue VARCHAR(200))"
//        };

//        String[] insertQueries = {
//                "INSERT INTO Vivekananda_General_Hospital (beds, ventilator, antidotes) VALUES (100, 20, 50)",
//                "INSERT INTO Hubli_Super_Speciality_Hospital (beds, ventilator, antidotes) VALUES (150, 30, 60)",
//                "INSERT INTO Shivakrupa_Hospital_Durgani (beds, ventilator, antidotes) VALUES (120, 25, 55)",
//                "INSERT INTO The_Banglore_Hospital (beds, ventilator, antidotes) VALUES (200, 40, 70)",
//                "INSERT INTO Manipal_Hospital_Yeshvanthpur (beds, ventilator, antidotes) VALUES (180, 35, 65)",
//                "INSERT INTO Victoria_Hospital (beds, ventilator, antidotes) VALUES (250, 50, 80)"
//        };
...
//            }
        ...
        submit.addActionListener(e -> {
            String newValue = data.getText();
            String updateQuery = "UPDATE The_Banglore_Hospital SET beds = ? WHERE tid = 1";

            try (Connection con = DriverManager.getConnection(url, username, password);
                 PreparedStatement pstmt = con.prepareStatement(updateQuery)) {

                // Set the new value for the beds column
        ...
        submitb1.addActionListener(e -> {
            String newValueVentilator = datab1.getText(); // Assuming dataVentilator is a JTextField for ventilator

            String updateQuery = "UPDATE The_Banglore_Hospital SET ventilator = ? WHERE tid = 1";

            try (Connection con = DriverManager.getConnection(url, username, password);
                 PreparedStatement pstmt = con.prepareStatement(updateQuery)) {

                // Set the new value for the ventilator column
                pstmt.setString(1, newValueVentilator);
        ...
        submitb2.addActionListener(e -> {
            String newValueVentilator = datab2.getText(); // Assuming dataVentilator is a JTextField for ventilator

            String updateQuery = "UPDATE The_Banglore_Hospital SET antidotes = ? WHERE tid = 1";
...
//            Mysore data
        ...
        submit5.addActionListener(e -> {
            String newValue = data5.getText();
            String updateQuery = "UPDATE The_Banglore_Hospital SET beds = ? WHERE tid = 1";
